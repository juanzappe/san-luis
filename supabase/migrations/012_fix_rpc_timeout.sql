...
-- 200k+ row joins.
--
-- Uses PostgreSQL's function-level SET clause (GUC override) which is
-- compatible with STABLE functions, unlike SET LOCAL inside the body.

SET search_path = public;

-- Recreate get_resumen_ejecutivo with extended timeout
...
-- Recreate get_comercial_clientes with extended timeout
...
-- Recreate get_comercial_proveedores with extended timeout
...
-- Recreate get_flujo_fondos with extended timeout
