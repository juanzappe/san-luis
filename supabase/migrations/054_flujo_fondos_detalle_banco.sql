-- 054_flujo_fondos_detalle_banco.sql
-- Add banco column to get_flujo_fondos_detalle() to show which bank
-- each movement comes from (provincia/santander/null for MP).
